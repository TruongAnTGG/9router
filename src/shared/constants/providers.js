...
export const APIKEY_PROVIDERS = {
  ...
  "xai-build": { id: "xai-build", alias: "xai-build", name: "xAI Build", icon: "construction", color: "#111827", textIcon: "XB", website: "https://x.ai", notice: { apiKeyUrl: "https://console.x.ai", text: "Optimized for agentic coding via xAI Responses API." }, serviceKinds: ["llm"] },
