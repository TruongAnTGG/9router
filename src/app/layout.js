...
const GA_MEASUREMENT_ID = "G-EEECEMDCZR";
...
export const metadata = {
  title: "LakeToken - AI Token Packages",
  description: "Sell AI token packages with API key delivery, quota, usage checks, and customer balance pages.",
  icons: {
    icon: "/favicon.svg",
  },
};
